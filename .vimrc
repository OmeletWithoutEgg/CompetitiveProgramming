...
vnoremap < <gv
vnoremap > >gv
command Codeforces %d<bar>r ~/CompetitiveProgramming/templates/main.cpp<bar>1d<bar>15,98fo<bar>106
...
function s:HaskellFastBuild()
    nnoremap <F9> :w<bar>!ghc % -o %:r -dynamic<CR>
    nnoremap <F10> :!./%:r<CR>
endfunction
...
augroup fastbuild
    ...
    au BufEnter *.hs call <SID>HaskellFastBuild()
